...
public class InitData {
    ...
    public HashMap<String,double[]> init(){
        String originDataFile = "system1\\AllData.txt"
        int N_TGU = 13,N_CHP = 6,N_HOU = 3,N_SPVP = 3,N_WTG = 1;

        int Dim = N_TGU + N_CHP*2 + N_HOU + N_SPVP + N_WTG;
        double[] P_H_MAX = new double[Dim], P_H_MIN = new double[Dim];
        ...
        int TGU_SIZE = 0,CHP_SIZE = 0,HOU_SIZE = 0,P_H_M_SIZE = 0, t = 1;
            ...
            while(s != null){
                if(s.equals("TGU")){
                    ...
                    while(s != null && !s.equals("CHP")){
                        String[] data = s.split(" ");
                        P_H_MIN[P_H_M_SIZE] = Double.parseDouble(data[1]);
                        P_TGU_MIN[P_H_M_SIZE] = Double.parseDouble(data[1]);
                        P_H_MAX[P_H_M_SIZE] = Double.parseDouble(data[2]);
                        P_TGU_MAX[P_H_M_SIZE] = Double.parseDouble(data[2]);
                    ...
                    while(s != null && !s.equals("HOU")){
                        ...
                        P_H_M_SIZE++;
                        P_H_MIN[P_H_M_SIZE] = Double.parseDouble(data[3]);
                        P_H_MAX[P_H_M_SIZE] = Double.parseDouble(data[4]);
                    ...
                    while(s != null && !s.equals("Need")){
                        String[] data = s.split(" ");
                        V_Wind_Real[t] = Double.parseDouble(data[2])*0.6 + Double.parseDouble(data[1])*0.4;
                        s = br.readLine();
                        t++;
                    }
        ...
        ret.put("P_H_MAX",P_H_MAX);ret.put("P_H_MIN",P_H_MIN);
